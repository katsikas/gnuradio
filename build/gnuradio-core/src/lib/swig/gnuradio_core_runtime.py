...
class x_vector_gr_basic_block_sptr(object):
    ...
    def begin(self):
        """begin(self) -> std::vector<(boost::shared_ptr<(gr_basic_block)>)>::const_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_basic_block_sptr_begin(self)

    def end(self):
        """end(self) -> std::vector<(boost::shared_ptr<(gr_basic_block)>)>::const_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_basic_block_sptr_end(self)

    def rbegin(self):
        """rbegin(self) -> std::vector<(boost::shared_ptr<(gr_basic_block)>)>::const_reverse_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_basic_block_sptr_rbegin(self)

    def rend(self):
        """rend(self) -> std::vector<(boost::shared_ptr<(gr_basic_block)>)>::const_reverse_iterator"""
...
class x_vector_gr_block_sptr(object):
    ...
    def begin(self):
        """begin(self) -> std::vector<(boost::shared_ptr<(gr_block)>)>::const_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_block_sptr_begin(self)

    def end(self):
        """end(self) -> std::vector<(boost::shared_ptr<(gr_block)>)>::const_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_block_sptr_end(self)

    def rbegin(self):
        """rbegin(self) -> std::vector<(boost::shared_ptr<(gr_block)>)>::const_reverse_iterator"""
        return _gnuradio_core_runtime.x_vector_gr_block_sptr_rbegin(self)

    def rend(self):
        """rend(self) -> std::vector<(boost::shared_ptr<(gr_block)>)>::const_reverse_iterator"""
