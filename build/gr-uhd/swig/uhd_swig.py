...
class uhd_usrp_source_sptr(object):
    ...
    def get_usrp_info(self, chan = 0):
        ...
        Returns identifying information about this USRP's configuration. Returns motherboard ID, name, and serial. Returns daughterboard RX ID, subdev name, and serial.
...
class uhd_usrp_sink_sptr(object):
    ...
    def get_usrp_info(self, chan = 0):
        ...
        Returns identifying information about this USRP's configuration. Returns motherboard ID, name, and serial. Returns daughterboard TX ID, subdev name, and serial.
