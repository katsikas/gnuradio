...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_avx_only = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX) | (1 << LV_ORC),
    "avx_only",
    32,
    ...
    {"generic", "sse3", "sse4_1"},
    {(1 << LV_GENERIC), (1 << LV_SSE3), (1 << LV_SSE4_1)},
    {volk_32fc_x2_dot_prod_32fc_a_generic, volk_32fc_x2_dot_prod_32fc_a_sse3, volk_32fc_x2_dot_prod_32fc_a_sse4_1},
    3,
...
#else
struct volk_machine volk_machine_avx_only = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX),
    "avx_only",
    32,
    "volk_16i_x4_quad_max_star_16i_a",
    {"sse2", "generic"},
