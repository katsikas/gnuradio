...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_sse2_32 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_32) | (1 << LV_ORC),
    "sse2_32",
    16,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_s32f_atan2_32f_a_sse, volk_32fc_s32f_atan2_32f_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_magnitude_squared_32f_u_sse, volk_32fc_magnitude_squared_32f_u_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16ic_s32f_magnitude_32f_a_sse, volk_16ic_s32f_magnitude_32f_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16ic_magnitude_16i_a_sse, volk_16ic_magnitude_16i_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_stddev_and_mean_32f_x2_a_sse, volk_32f_stddev_and_mean_32f_x2_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_s32f_stddev_32f_a_sse, volk_32f_s32f_stddev_32f_a_generic},
    2,
    "volk_16ic_deinterleave_real_16i_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
    {volk_16ic_deinterleave_real_16i_a_sse2, volk_16ic_deinterleave_real_16i_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_8ic_s32f_deinterleave_real_32f_a_sse, volk_8ic_s32f_deinterleave_real_32f_a_generic},
    2,
    ...
    {volk_16ic_deinterleave_16i_x2_a_sse2, volk_16ic_deinterleave_16i_x2_a_generic, volk_16ic_deinterleave_16i_x2_a_orc},
    3,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16i_s32f_convert_32f_u_sse, volk_16i_s32f_convert_32f_u_generic},
    2,
    "volk_32fc_x2_dot_prod_32fc_a",
    {"generic", "sse_32"},
    {(1 << LV_GENERIC), (1 << LV_SSE) | (1 << LV_32)},
    {volk_32fc_x2_dot_prod_32fc_a_generic, volk_32fc_x2_dot_prod_32fc_a_sse_32},
    2,
    "volk_32f_sqrt_32f_a",
    {"sse", "generic", "orc"},
    {(1 << LV_SSE), (1 << LV_GENERIC), (1 << LV_ORC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_8ic_s32f_deinterleave_32f_x2_a_sse, volk_8ic_s32f_deinterleave_32f_x2_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_magnitude_32f_u_sse, volk_32fc_magnitude_32f_u_generic},
    2,
    ...
    {"sse", "generic", "orc"},
    {(1 << LV_SSE), (1 << LV_GENERIC), (1 << LV_ORC)},
    {volk_32fc_magnitude_32f_a_sse, volk_32fc_magnitude_32f_a_generic, volk_32fc_magnitude_32f_a_orc},
    3,
    "volk_32f_x2_dot_prod_32f_u",
    {"generic", "sse"},
    {(1 << LV_GENERIC), (1 << LV_SSE)},
    {volk_32f_x2_dot_prod_32f_u_generic, volk_32f_x2_dot_prod_32f_u_sse},
    2,
    "volk_64u_popcnt_a",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_magnitude_squared_32f_a_sse, volk_32fc_magnitude_squared_32f_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16i_s32f_convert_32f_a_sse, volk_16i_s32f_convert_32f_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_s32f_power_32f_a_sse, volk_32f_s32f_power_32f_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_index_max_16u_a_sse, volk_32f_index_max_16u_a_generic},
    2,
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16ic_s32f_deinterleave_real_32f_a_sse, volk_16ic_s32f_deinterleave_real_32f_a_generic},
    2,
    "volk_32f_x2_dot_prod_32f_a",
    {"generic", "sse"},
    {(1 << LV_GENERIC), (1 << LV_SSE)},
    {volk_32f_x2_dot_prod_32f_a_generic, volk_32f_x2_dot_prod_32f_a_sse},
    2,
    ...
    {"generic", "sse_32"},
    {(1 << LV_GENERIC), (1 << LV_SSE) | (1 << LV_32)},
    {volk_32fc_x2_conjugate_dot_prod_32fc_a_generic, volk_32fc_x2_conjugate_dot_prod_32fc_a_sse_32},
    2,
    ...
    {"sse", "generic", "orc"},
    {(1 << LV_SSE), (1 << LV_GENERIC), (1 << LV_ORC)},
    {volk_32fc_s32f_magnitude_16i_a_sse, volk_32fc_s32f_magnitude_16i_a_generic, volk_32fc_s32f_magnitude_16i_a_orc},
    3,
...
#else
struct volk_machine volk_machine_sse2_32 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_32),
    "sse2_32",
    16,
    "volk_32f_x2_multiply_32f_u",
    {"sse", "generic"},
    ...
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
    {volk_16ic_deinterleave_16i_x2_a_sse2, volk_16ic_deinterleave_16i_x2_a_generic},
    2,
    "volk_16i_max_star_16i_a",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_subtract_32f_a_sse, volk_32f_x2_subtract_32f_a_generic},
    2,
    "volk_8i_s32f_convert_32f_u",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_sqrt_32f_a_sse, volk_32f_sqrt_32f_a_generic},
    2,
    "volk_8ic_s32f_deinterleave_32f_x2_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_divide_32f_a_sse, volk_32f_x2_divide_32f_a_generic},
    2,
    "volk_8ic_x2_s32f_multiply_conjugate_32fc_a",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_add_32f_a_sse, volk_32f_x2_add_32f_a_generic},
    2,
    "volk_32fc_magnitude_32f_u",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32i_x2_and_32i_a_sse, volk_32i_x2_and_32i_a_generic},
    2,
    "volk_32fc_deinterleave_imag_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_s32f_normalize_a_sse, volk_32f_s32f_normalize_a_generic},
    2,
    "volk_32fc_magnitude_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_magnitude_32f_a_sse, volk_32fc_magnitude_32f_a_generic},
    2,
    "volk_32f_x2_dot_prod_32f_u",
    {"generic", "sse"},
    {(1 << LV_GENERIC), (1 << LV_SSE)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_s32f_multiply_32f_a_sse, volk_32f_s32f_multiply_32f_a_generic},
    2,
    "volk_32f_x2_min_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_min_32f_a_sse, volk_32f_x2_min_32f_a_generic},
    2,
    "volk_32fc_x2_multiply_32fc_a",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_max_32f_a_sse, volk_32f_x2_max_32f_a_generic},
    2,
    "volk_16i_permute_and_scalar_add_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_16ic_s32f_deinterleave_32f_x2_a_sse, volk_16ic_s32f_deinterleave_32f_x2_a_generic},
    2,
    "volk_16u_byteswap_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
    {volk_16u_byteswap_a_sse2, volk_16u_byteswap_a_generic},
    2,
    "volk_32f_s32f_power_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32i_x2_or_32i_a_sse, volk_32i_x2_or_32i_a_generic},
    2,
    "volk_16ic_s32f_deinterleave_real_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_x2_multiply_32f_a_sse, volk_32f_x2_multiply_32f_a_generic},
    2,
    "volk_32fc_x2_s32f_square_dist_scalar_mult_32f_a",
    {"generic"},
    {(1 << LV_GENERIC)},
    ...
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_s32f_magnitude_16i_a_sse, volk_32fc_s32f_magnitude_16i_a_generic},
    2,
    "volk_32fc_32f_multiply_32fc_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_32f_multiply_32fc_a_sse, volk_32fc_32f_multiply_32fc_a_generic},
    2
};
