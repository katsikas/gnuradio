...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_avx_32 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX) | (1 << LV_32) | (1 << LV_ORC),
    "avx_32",
    32,
    ...
    {"sse", "avx", "generic"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC)},
    {volk_32f_x2_multiply_32f_u_sse, volk_32f_x2_multiply_32f_u_avx, volk_32f_x2_multiply_32f_u_generic},
    3,
    ...
    {"sse", "avx", "generic", "orc"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC), (1 << LV_ORC)},
    {volk_32f_x2_multiply_32f_a_sse, volk_32f_x2_multiply_32f_a_avx, volk_32f_x2_multiply_32f_a_generic, volk_32f_x2_multiply_32f_a_orc},
    4,
    ...
    {"avx", "sse2", "sse", "generic"},
    {(1 << LV_AVX), (1 << LV_SSE2), (1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32f_s32f_convert_32i_a_avx, volk_32f_s32f_convert_32i_a_sse2, volk_32f_s32f_convert_32i_a_sse, volk_32f_s32f_convert_32i_a_generic},
    4,
    "volk_16u_byteswap_a",
    {"sse2", "generic", "orc"},
    ...
    "volk_32u_popcnt_a",
    {"generic", "sse4_2"},
    {(1 << LV_GENERIC), (1 << LV_SSE4_2)},
    {volk_32u_popcnt_a_generic, volk_32u_popcnt_a_sse4_2},
    2,
    ...
    {"sse", "avx", "generic"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC)},
    {volk_32f_s32f_multiply_32f_u_sse, volk_32f_s32f_multiply_32f_u_avx, volk_32f_s32f_multiply_32f_u_generic},
    3,
    ...
    {"generic", "sse_32", "sse3", "sse4_1"},
    {(1 << LV_GENERIC), (1 << LV_SSE) | (1 << LV_32), (1 << LV_SSE3), (1 << LV_SSE4_1)},
    {volk_32fc_x2_dot_prod_32fc_a_generic, volk_32fc_x2_dot_prod_32fc_a_sse_32, volk_32fc_x2_dot_prod_32fc_a_sse3, volk_32fc_x2_dot_prod_32fc_a_sse4_1},
    4,
    ...
    {"sse", "avx", "generic", "orc"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC), (1 << LV_ORC)},
    {volk_32f_s32f_multiply_32f_a_sse, volk_32f_s32f_multiply_32f_a_avx, volk_32f_s32f_multiply_32f_a_generic, volk_32f_s32f_multiply_32f_a_orc},
    4,
    "volk_32u_byteswap_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
...
#else
struct volk_machine volk_machine_avx_32 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX) | (1 << LV_32),
    "avx_32",
    32,
    "volk_32f_x2_subtract_32f_a",
    {"sse", "generic"},
    ...
    {"sse4_1", "generic"},
    {(1 << LV_SSE4_1), (1 << LV_GENERIC)},
    {volk_8i_s32f_convert_32f_a_sse4_1, volk_8i_s32f_convert_32f_a_generic},
    2,
    "volk_32fc_conjugate_32fc_u",
    {"sse3", "generic"},
    {(1 << LV_SSE3), (1 << LV_GENERIC)},
    ...
    {"sse4_1", "generic"},
    {(1 << LV_SSE4_1), (1 << LV_GENERIC)},
    {volk_8i_convert_16i_a_sse4_1, volk_8i_convert_16i_a_generic},
    2,
    "volk_32i_s32f_convert_32f_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
    ...
    {"sse3", "sse", "generic"},
    {(1 << LV_SSE3), (1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_s32f_magnitude_16i_a_sse3, volk_32fc_s32f_magnitude_16i_a_sse, volk_32fc_s32f_magnitude_16i_a_generic},
    3,
    "volk_32fc_deinterleave_real_32f_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "avx", "generic"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC)},
    {volk_32f_x2_multiply_32f_a_sse, volk_32f_x2_multiply_32f_a_avx, volk_32f_x2_multiply_32f_a_generic},
    3,
    "volk_32i_x2_and_32i_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse3", "generic"},
    {(1 << LV_SSE3), (1 << LV_GENERIC)},
    {volk_32fc_x2_multiply_32fc_a_sse3, volk_32fc_x2_multiply_32fc_a_generic},
    2,
    "volk_32fc_s32fc_multiply_32fc_u",
    {"sse3", "generic"},
    {(1 << LV_SSE3), (1 << LV_GENERIC)},
    ...
    {"ssse3", "sse2", "generic"},
    {(1 << LV_SSSE3), (1 << LV_SSE2), (1 << LV_GENERIC)},
    {volk_16ic_deinterleave_16i_x2_a_ssse3, volk_16ic_deinterleave_16i_x2_a_sse2, volk_16ic_deinterleave_16i_x2_a_generic},
    3,
    "volk_32fc_index_max_16u_a",
    {"sse3", "generic"},
    {(1 << LV_SSE3), (1 << LV_GENERIC)},
    ...
    {"sse3", "sse", "generic"},
    {(1 << LV_SSE3), (1 << LV_SSE), (1 << LV_GENERIC)},
    {volk_32fc_magnitude_32f_a_sse3, volk_32fc_magnitude_32f_a_sse, volk_32fc_magnitude_32f_a_generic},
    3,
    "volk_32f_s32f_convert_32i_u",
    {"sse2", "sse", "generic"},
    {(1 << LV_SSE2), (1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"ssse3", "generic"},
    {(1 << LV_SSSE3), (1 << LV_GENERIC)},
    {volk_16ic_deinterleave_real_8i_a_ssse3, volk_16ic_deinterleave_real_8i_a_generic},
    2,
    "volk_32f_x2_interleave_32fc_a",
    {"sse", "generic"},
    {(1 << LV_SSE), (1 << LV_GENERIC)},
    ...
    {"sse", "avx", "generic"},
    {(1 << LV_SSE), (1 << LV_AVX), (1 << LV_GENERIC)},
    {volk_32f_s32f_multiply_32f_a_sse, volk_32f_s32f_multiply_32f_a_avx, volk_32f_s32f_multiply_32f_a_generic},
    3,
    "volk_32u_byteswap_a",
    {"sse2", "generic"},
    {(1 << LV_SSE2), (1 << LV_GENERIC)},
