...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_sse2_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_64) | (1 << LV_ORC),
    "sse2_64",
    16,
    ...
    {"generic", "sse_64"},
    {(1 << LV_GENERIC), (1 << LV_SSE) | (1 << LV_64)},
    {volk_32fc_x2_dot_prod_32fc_a_generic, volk_32fc_x2_dot_prod_32fc_a_sse_64},
    2,
...
#else
struct volk_machine volk_machine_sse2_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_64),
    "sse2_64",
    16,
    "volk_32f_x2_subtract_32f_a",
    {"sse", "generic"},
