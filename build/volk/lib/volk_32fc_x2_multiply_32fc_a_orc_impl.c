...
/* autogenerated from volk_32fc_x2_multiply_32fc_a_orc_impl.orc */
...
#include <orc/orc.h>
#endif
void volk_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n);
...
/* volk_32fc_x2_multiply_32fc_a_orc_impl */
#ifdef DISABLE_ORC
void
volk_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n){
  int i;
...
#else
static void
_backup_volk_32fc_x2_multiply_32fc_a_orc_impl (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union64 * ORC_RESTRICT ptr0;
...
volk_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new ();
      orc_program_set_name (p, "volk_32fc_x2_multiply_32fc_a_orc_impl");
      orc_program_set_backup_function (p, _backup_volk_32fc_x2_multiply_32fc_a_orc_impl);
      ...
      orc_program_append_2 (p, "mulf", 1, ORC_VAR_T1, ORC_VAR_S1, ORC_VAR_S2, ORC_VAR_D1);
      ...
      orc_program_append_2 (p, "mulf", 1, ORC_VAR_T1, ORC_VAR_T6, ORC_VAR_S2, ORC_VAR_D1);
      orc_program_append_2 (p, "splitql", 0, ORC_VAR_T5, ORC_VAR_T4, ORC_VAR_T1, ORC_VAR_D1);
