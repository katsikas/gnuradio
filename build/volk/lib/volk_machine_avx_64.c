...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_avx_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX) | (1 << LV_64) | (1 << LV_ORC),
    "avx_64",
    32,
    ...
    "volk_64u_popcnt_a",
    {"generic", "sse4_2"},
    {(1 << LV_GENERIC), (1 << LV_SSE4_2) | (1 << LV_64)},
    {volk_64u_popcnt_a_generic, volk_64u_popcnt_a_sse4_2},
    2,
...
#else
struct volk_machine volk_machine_avx_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_SSSE3) | (1 << LV_SSE4_1) | (1 << LV_SSE4_2) | (1 << LV_POPCOUNT) | (1 << LV_AVX) | (1 << LV_64),
    "avx_64",
    32,
    "volk_32f_x2_multiply_32f_u",
    {"sse", "avx", "generic"},
