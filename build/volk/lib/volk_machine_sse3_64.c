...
#ifdef LV_HAVE_ORC
struct volk_machine volk_machine_sse3_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_64) | (1 << LV_ORC),
    "sse3_64",
    16,
...
#else
struct volk_machine volk_machine_sse3_64 = {
    (1 << LV_GENERIC) | (1 << LV_MMX) | (1 << LV_SSE) | (1 << LV_SSE2) | (1 << LV_SSE3) | (1 << LV_64),
    "sse3_64",
    16,
    "volk_32f_x2_subtract_32f_a",
    {"sse", "generic"},
