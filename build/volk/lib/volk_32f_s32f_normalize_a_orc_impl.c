...
/* autogenerated from volk_32f_s32f_normalize_a_orc_impl.orc */
...
#include <orc/orc.h>
#endif
void volk_32f_s32f_normalize_a_orc_impl (orc_uint32 * ORC_RESTRICT d1, const orc_uint32 * ORC_RESTRICT s1, float p1, int n);
...
#else
static void
_backup_volk_32f_s32f_normalize_a_orc_impl (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 * ORC_RESTRICT ptr0;
...
volk_32f_s32f_normalize_a_orc_impl (orc_uint32 * ORC_RESTRICT d1, const orc_uint32 * ORC_RESTRICT s1, float p1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new ();
      orc_program_set_name (p, "volk_32f_s32f_normalize_a_orc_impl");
      orc_program_set_backup_function (p, _backup_volk_32f_s32f_normalize_a_orc_impl);
